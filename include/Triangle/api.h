 ...
 * @param ctx Pointer to context struct.
 * @param in Pointer to triangleio struct, containing a previously computed
 * mesh.
 * @return Integer status code.
 */
 ...
 * @return Integer status code.
 */
EXPORT int triangle_mesh_copy (context *ctx, triangleio *out, int edges,
                               int neighbors);
 ...
 * @return Integer status code.
 */
EXPORT int triangle_write_poly (context *ctx, FILE *file, REAL *holelist,
 ...
 * @return Integer status code.
 */
EXPORT int triangle_read_nodes (const char *filename, triangleio *io,
                                int *firstnode);
 ...
 * @return Integer status code.
 */
EXPORT int triangle_read_poly (const char *filename, triangleio *io,
                               int *firstnode);

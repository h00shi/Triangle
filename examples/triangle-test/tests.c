...
void
assert (int result, char *message)
{
  if (result)
    {
      printf ("OK: %s\n", message);
...
int
test_mesh_statistics (context *ctx)
{
  statistics s;
...
int
test_mesh_load_refine (context *ctx)
{
  triangleio in;
  mesh *m;

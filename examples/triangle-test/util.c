...
void
triangleio_reset (triangleio *io)
{
...
void
create_rectangle (triangleio *in, REAL left, REAL top, REAL right, REAL bottom)
{
  triangleio_reset (in);
...
void
create_rectangle_mesh (triangleio *in, REAL left, REAL top, REAL right,
                       REAL bottom)
{
  triangleio_reset (in);
  ...
  in->trianglelist = (int *) malloc (in->numberoftriangles * in->numberofcorners
                                     * sizeof (int));
  in->trianglelist[0] = 3;
  in->trianglelist[1] = 0;
  in->trianglelist[2] = 1;
  ...
  in->triangleattributelist
    = (REAL *) malloc (in->numberoftriangles * sizeof (REAL));

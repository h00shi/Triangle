...
REAL
counterclockwiseadapt (vertex pa, vertex pb, vertex pc, REAL detsum)
{
...
REAL
counterclockwise (mesh *m, behavior *b, vertex pa, vertex pb, vertex pc)
{
      ...
      if (adxtail != 0.0)
        {
          ...
          temp32blen
            = fast_expansion_sum_zeroelim (temp16alen, temp16a, temp16blen,
                                           temp16b, temp32b);
...
REAL
incircle (mesh *m, behavior *b, vertex pa, vertex pb, vertex pc, vertex pd)
{
...
REAL
orient3d (mesh *m, behavior *b, vertex pa, vertex pb, vertex pc, vertex pd,
...
REAL
nonregular (mesh *m, behavior *b, vertex pa, vertex pb, vertex pc, vertex pd)
{
  if (b->weighted == 0)
    {
...
void
findcircumcenter (mesh *m, behavior *b, vertex torg, vertex tdest, vertex tapex,
